      var Triangle = function(loc){
        ...
        MAX_DISTANCE = 30; //How far do I get from the origin
        WILL_STRENGTH = 0.8; //How independent I am
      ...
      var Flocker = function(numParticles){
        ...
        for (var i=0; i < numParticles; i++) {
          ...
          //Setup Color
          // /context.fillStyle = "rgba(0, 0, 0, " + 200 + ")";
          ...
          for (i=0; i < particles.length; i++) {
            ...
            if(random_color===0){
              ...
              context.fillStyle = "rgba(200, 0, 200, " + particlesAlpha + ")";    
            }else{
              context.fillStyle = "rgba(42, 105, 127, " + particlesAlpha + ")";
            }
